...
export const AboutAndSeoSection: React.FC = () => {
  ...
  const shortDescription =
    "DeskHub emulator v1.1.2 - Ultra-high performance GameHub ReVanced modification with Rust Vulkan 1.3/1.4 native core, Direct Input uinput dispatcher, AAudio Oboe lock-free audio engine, memory-mapped Zstd VFS, ARM NEON SIMD vectorization, and automated GitHub Actions CI/CD APK builds.";

  const githubAbout =
    "⚡ DeskHub emulator v1.1.2: Next-Gen PC gaming on Android (GameHub ReVanced mod). Powered by Rust native Vulkan 1.3/1.4 engine, Direct Input uinput, AAudio lock-free audio, Zstd VFS, DXVK Async, and automated CI/CD builds.";

  const fullMarkdownAbout = `## 🎮 About DeskHub emulator v1.1.2
